...
<%--<body>--%>
<%--&lt;%&ndash;<div class="modal" id="mymodal">&ndash;%&gt;--%>
<%--&lt;%&ndash;    <div class="modal-dialog">&ndash;%&gt;--%>
<%--&lt;%&ndash;        <div class="modal-content">&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="modal-header">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <h3 class="text-light text-center">Post</h3>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="modal-body">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <div class="innerbody apply-jobbox">&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <h3>What is on your mind?</h3>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <form>&ndash;%&gt;--%>
<%--&lt;%&ndash;                            <textarea name="description" placeholder="What's on your mind?" style="width: 100%; padding:15px; height: 130px;     width: 100%;&ndash;%&gt;--%>
<%--&lt;%&ndash;                            color: #b2b2b2;&ndash;%&gt;--%>
<%--&lt;%&ndash;                            font-size: 14px;&ndash;%&gt;--%>
<%--&lt;%&ndash;                            border: 1px solid #e5e5e5;&ndash;%&gt;--%>
<%--&lt;%&ndash;                            font-weight: 500;"></textarea>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </form>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    <div class="select-files">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <input type="file" class="custom-file-input">&ndash;%&gt;--%>
<%--&lt;%&ndash;                        <p>Upload your cv / resume file. Max file size : 3MB</p>&ndash;%&gt;--%>
<%--&lt;%&ndash;                    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;                </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;            <div class="modal-footer">&ndash;%&gt;--%>
<%--&lt;%&ndash;                <button class="place-bid-btn">Post</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;                <button>Cancel</button>&ndash;%&gt;--%>
<%--&lt;%&ndash;            </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;        </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;    </div>&ndash;%&gt;--%>
<%--&lt;%&ndash;</div>&ndash;%&gt;--%>
