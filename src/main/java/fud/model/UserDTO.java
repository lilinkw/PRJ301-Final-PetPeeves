...
public class UserDTO {
    ...
    public UserDTO(String userID,String userName,String fullname,String avatarLink, boolean isAdmin,boolean status) {
        this.userID = userID;
    ...
    public UserDTO(String userID, String fullname, String avatarLink, String gender, String location, boolean isAdmin, boolean status) {
        this.userID = userID;
        this.fullname = fullname;
        this.avatarLink = avatarLink;
        this.gender = gender;
